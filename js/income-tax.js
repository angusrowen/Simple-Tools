...
var _isMobile = window.innerWidth<=768 || (navigator.maxTouchPoints>0 && window.innerWidth<=1024);
if(_isMobile){
  ...
  ['freqFortnightly','freqWeekly','freqMonthly'].forEach(function(id){
    ...
    document.querySelectorAll(
      'ins.adsbygoogle,.ad-slot,.mobile-ad-slot,.mobile-ad-inner,.side-rail,[data-ad-client],[data-ad-slot]'
    ).forEach(function(el){el.parentNode&&el.parentNode.removeChild(el);});
    document.querySelectorAll('script[src*="googlesyndication"]')
      .forEach(function(el){el.parentNode&&el.parentNode.removeChild(el);});
  });

if(window.innerWidth>768 && navigator.maxTouchPoints===0){document.write('<scr'+'ipt async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-XXXXXXXXXXXXXXXX" crossorigin="anonymous"></scr'+'ipt>');}
